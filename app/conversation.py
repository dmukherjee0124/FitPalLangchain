...
def conversation(age, goal, level, days, weeks, time, style, gym, health, current_week):
    ...
    template = """
                        ...
                        Create the first week plan for only {days} days in the form of - Week 1: Day 1: workout ...etc..till {days} days 
    ...
    if week_total > 1:
        while current_week<= week_total:
            ...
            template = """
                                    ...
                                    Create the week for only {days} days in the form of - Week {current_week}: Day 1: workout ... till {days} days 
